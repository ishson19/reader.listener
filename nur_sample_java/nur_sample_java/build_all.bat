...
"%JAVA_HOME%\bin\javac" -d "transports/NurApiSerialTransport/bin" -cp "%RXTXJAR%;import/NurApi.jar;import/epctagcoder.jar" transports/NurApiSerialTransport/src/com/nordicid/nurapi/*.java
...
"%JAVA_HOME%\bin\javac" -d "transports/NurApiSocketTransport/bin" -cp "%RXTXJAR%;import/NurApi.jar;import/epctagcoder.jar" transports/NurApiSocketTransport/src/com/nordicid/nurapi/*.java
...
"%JAVA_HOME%\bin\javac" -d "samples/SamplesCommon/bin" -cp "transports/jars/*;%RXTXJAR%;import/NurApi.jar;import/epctagcoder.jar" samples/SamplesCommon/src/com/nordicid/samples/common/*.java
...
REM compile
"%JAVA_HOME%\bin\javac" -d "%~1/bin" -cp "samples/SamplesCommon/bin;transports/jars/*;%RXTXJAR%;import/NurApi.jar;import/epctagcoder.jar" %~1/src/com/nordicid/testapplication/*.java
goto:eof